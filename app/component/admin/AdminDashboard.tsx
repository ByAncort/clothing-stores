      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900 p-6 rounded-xl border border-gray-800 h-fit shadow-lg">
            <h2 className="text-xl font-bold mb-4 text-indigo-400 uppercase">
              Nuevo Producto
            </h2>
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-indigo-600 hover:bg-indigo-500 py-3 rounded font-bold mt-2 uppercase tracking-wide"
              >
                Guardar Producto
              </button>
            </form>
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <td className="px-4 py-3">
                        <img
                          src={product.imagenUrl || "https://placehold.co/50"}
                      ...
                      <td className="px-4 py-3 text-right">
                        <button
                          ...
                          className="text-red-400 hover:text-red-300 font-bold border border-red-900/50 bg-red-900/10 px-3 py-1 rounded hover:bg-red-900/30"
                        >
                          ELIMINAR
                        </button>
                      </td>
