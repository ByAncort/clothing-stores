...
const Footer = () => {
  return (
<footer
  className="flex flex-col items-center bg-zinc-800 text-center text-surface dark:bg-neutral-700 text-white">
  ...
  <div className="w-full bg-black/5 p-4 text-center">
    © 2025,
    <a href="https://tw-elements.com/">Stay Cold Apparel. All Rights reserved.</a>
  </div>
</footer>
  )
}
