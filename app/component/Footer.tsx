      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-medium text-white tracking-wider">STAY COLD</h3>
            <p className="text-gray-400 mt-2 text-right text-sm">Apparel</p>
          </div>
          ...
          <div className="flex justify-center space-x-4">
            {socialLinks.map((social) => (
              <a
                key={social.name}
                href={social.href}
                className="group p-3 backdrop-blur-md rounded-full border border-gray-700 hover:bg-gray-700 hover:border-gray-600 transition-all duration-300 transform hover:scale-110"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              {['Política de Privacidad', 'Términos de Servicio', 'Aviso Legal'].map((item) => (
                <a
                  key={item}
                  href="#"
